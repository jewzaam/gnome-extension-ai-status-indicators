...
// Mock StatusIndicator class for testing without GObject complexity
...
class StatusIndicator {
    constructor(name, readyIcon, workingIcon, waitingIcon, showLabel) {
        ...
        this._iconLabel = {
            ...
            set_text: jest.fn((text) => {
                this._iconLabel.text = text;
            })
        };

        this.children = [this._iconLabel];
        this.tooltip_text = this._name;
        ...
        if (this._showLabel) {
            ...
            this.children.push(this._textLabel);
        }
    }
...
describe('StatusIndicator', () => {
    ...
    describe('initialization', () => {
        test('should create indicator with correct initial state', () => {
            ...
            expect(indicator._workingIcon).toBe('⚠️');
    ...
    describe('updateConfig', () => {
        test('should update icons and name', () => {
            ...
            expect(indicator._waitingIcon).toBe('🔴');
            expect(indicator._iconLabel.text).toBe('🟢'); // Should show ready icon
        });
